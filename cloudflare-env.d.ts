/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1fcc08d4e52d799b1ecd2b35ef2681ca)
...
interface __BaseEnv_CloudflareEnv {
	...
	MIN_EVIDENCE_PHOTOS: string;
	NEXT_PUBLIC_MAPS_PROVIDER: string;
	NEXT_PUBLIC_GOOGLE_MAPS_API_KEY: string;
	NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID: string;
	ENABLE_EXTERNAL_EMAIL: string;
	ENABLE_EXTERNAL_WHATSAPP: string;
	NEXT_PUBLIC_ENABLE_EXTERNAL_WHATSAPP: string;
	SMTP_HOST: string;
	SMTP_PORT: string;
	SMTP_SECURE: string;
	SMTP_USER: string;
	SMTP_PASS: string;
	SMTP_FROM: string;
	WORKER_SELF_REFERENCE: Fetcher /* jobmanagement */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEXTAUTH_URL" | "NEXTAUTH_SECRET" | "NEXT_PUBLIC_APP_URL" | "UPLOAD_DIR" | "GEOFENCE_RADIUS_METERS" | "MIN_EVIDENCE_PHOTOS" | "NEXT_PUBLIC_MAPS_PROVIDER" | "NEXT_PUBLIC_GOOGLE_MAPS_API_KEY" | "NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID" | "ENABLE_EXTERNAL_EMAIL" | "ENABLE_EXTERNAL_WHATSAPP" | "NEXT_PUBLIC_ENABLE_EXTERNAL_WHATSAPP" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_USER" | "SMTP_PASS" | "SMTP_FROM">> {}
}
